...
{
    public static final ConfigHotkey OPEN_CONFIG_GUI = new ConfigHotkey("openConfigGui", "LEFT_ALT,M", "Open the AeTweaks config GUI");
    ...
    public static final ConfigHotkey RESET_SESSION = new ConfigHotkey("resetSession", "", "Reset the current mining session");
